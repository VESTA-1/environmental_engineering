...
def original_data_process(data):
    ...
    result.to_csv('data/data5.csv', encoding='utf-8_sig', index=False)
    # exit()
    # result = pd.read_csv('./data/data5.csv')
    # exit()
    ...
    train_data.to_csv('data/train5.csv', encoding='utf-8_sig', index=False)
    return train_data
...
origin_data = read_data('data/original_data_5.xlsx')
print(origin_data)
